...
class _GlowingMarkerState extends State<_GlowingMarker>
  ...
  @override
  Widget build(BuildContext context) {
    return Container(); // Return empty container since Marker is not a Widget
  }
}
...
class _GlowingPolyline extends StatelessWidget {
  ...
  Polyline buildPolyline() {
    return Polyline(
      ...
      width: width.toInt() * glowIntensity.toInt(),
      points: points,
      patterns: [
        PatternItem.dash(20),
      ],
  ...
  @override
  Widget build(BuildContext context) {
    return Container(); // Return empty container since Polyline is not a Widget
  }
}

...
class AppGradients {
  ...
  // Gradient utilities
  static Gradient lerpGradient(Gradient gradient1, Gradient gradient2, double t) {
    ...
    if (gradient1 is LinearGradient && gradient2 is LinearGradient) {
      ...
      return LinearGradient(
        colors: [
          Color.lerp(g1.colors.first, g2.colors.first, t) ?? Colors.transparent,
          Color.lerp(g1.colors.last, g2.colors.last, t) ?? Colors.transparent,
        ],
        begin: Alignment.lerp(g1.begin as Alignment, g2.begin as Alignment, t) ?? Alignment.topLeft,
        end: Alignment.lerp(g1.end as Alignment, g2.end as Alignment, t) ?? Alignment.bottomRight,

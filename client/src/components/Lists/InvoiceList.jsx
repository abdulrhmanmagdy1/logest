/**
 * ============================================
 * 📄 Invoice List Component - نظام إدهام
 * Edham Logistics - Invoice List
 * ============================================
 */

import React, { useState, useEffect } from 'react';
import api from '../../services/api';
import { Loader, AlertCircle, FileText, Search, Filter, Plus, Download } from 'lucide-react';
              ...
              {filteredInvoices.length === 0 ? (
                ...
                filteredInvoices.map((invoice) => (
                  <tr key={invoice._id} className="border-t border-gray-700 hover:bg-gray-700">
                    ...
                    <td className="px-4 py-3">{invoice.balanceDue} ريال</td>

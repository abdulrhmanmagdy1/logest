...
import '../../../../core/widgets/premium/modern_widgets.dart';
...
class _PremiumSupervisorDashboardState extends State<PremiumSupervisorDashboard>
      ...
      child: Column(
        children: [
          Row(
            children: [
              ModernStatusChip(
                label: _getStatusText(shipment.status),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(),
              ModernStatusChip(
                label: _getVehicleStatusText(vehicle.status),
                backgroundColor: _getVehicleStatusColor(vehicle.status),
                textColor: Colors.white,
                selected: vehicle.status == 'active',
              ),
            ],
          ),
        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: PremiumLineChart(
                  ...
                  title: 'معدل التوصيل',
                  subtitle: '+2.3% عن الأسبوع الماضي',
                  primaryColor: AppTheme.success,
                  showGrid: true,
                  showTooltip: true,
                  animationDuration: const Duration(milliseconds: 800),
                  isAnimated: true,
                  onPointTapped: (data) => _showChartDetails('معدل التوصيل', data),
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: PremiumBarChart(
                  data: ChartAnalytics.generateRandomData(
                    count: 5,
                    minValue: 90,
                    maxValue: 100,
                  ...
                  animationDuration: const Duration(milliseconds: 800),
                  isAnimated: true,
                  onBarTapped: (data) => _showChartDetails('رضا العملاء', data),
                ),
              ),
            ],
          ),
            ...
            children: [
              Expanded(
                child: PremiumAreaChart(
                  ...
                  title: 'كفاءة الوقود',
                  subtitle: '+3.7% هذا الشهر',
                  primaryColor: AppTheme.accent,
                  showGrid: true,
                  showTooltip: true,
                  animationDuration: const Duration(milliseconds: 800),
                  isAnimated: true,
                  onPointTapped: (data) => _showChartDetails('كفاءة الوقود', data),
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: PremiumPieChart(
                  data: [
                    ChartData('ممتاز', 45),
                    ChartData('جيد', 30),
                    ChartData('متوسط', 20),
                  ...
                  title: 'توزيع الاستجابة',
                  subtitle: 'متوسط 12 دقيقة',
                  colors: [AppTheme.success, AppTheme.primary, AppTheme.warning, AppTheme.error],
                  animationDuration: const Duration(milliseconds: 800),
                  isAnimated: true,
                  onSliceTapped: (data) => _showChartDetails('توزيع الاستجابة', data),
                  showLabels: true,
                  showLegend: true,
                ),
              ),
          ...
          PremiumGaugeChart(
            value: _vehicleUtilization,
            maxValue: 100,
            title: 'استغلال الأسطول',
            subtitle: 'نسبة المركبات النشطة',
            unit: '%',
            primaryColor: AppTheme.primary,
  ...
  void _showChartDetails(String chartTitle, ChartData data) {
    showDialog(
      context: context,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'النتيجة: ${data.y.toStringAsFixed(2)}%',
                    style: const TextStyle(
                      color: AppTheme.textPrimary,
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                ...
                Expanded(
                  child: ModernQuickActionButton(
                    ...
                    onPressed: () {
                      ...
                      _showDetailedReport(chartTitle, data);
                    },
                    backgroundColor: Colors.transparent,
  ...
  void _showDetailedReport(String chartTitle, ChartData data) {
    // Navigate to detailed report screen
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('جاري تحميل تقرير مفصل لـ $chartTitle'),
        backgroundColor: AppTheme.primary,
